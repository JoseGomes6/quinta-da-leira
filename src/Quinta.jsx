  ...
  return (
    <div className="bg-[#FBF9F5] text-[#1C2826] antialiased font-light selection:bg-[#E2D4C3] selection:text-[#1C2826]">
      ...
      <main className="pt-40 pb-32">
        ...
        {/* Bloco de Abertura: Imagem Imersiva com Legenda */}
        <section className="max-w-6xl mx-auto px-6 mb-28">
          <div className="relative h-[450px] md:h-[620px] w-full overflow-hidden rounded-[2px] shadow-2xl group">
            <img
              src="/foto-hero1.jpeg"
              alt="Quinta da Leira Vista Panorâmica"
              className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
            <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 text-white space-y-1">
              <span className="text-[9px] tracking-[0.4em] uppercase text-amber-200">
                Alijó, Vila Real
              </span>
              <h2 className="text-lg md:text-2xl font-serif font-light">
                Encostas verticais banhadas por luz pura
              </h2>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-6 text-center space-y-8 mb-32">
          ...
          <p className="text-stone-600 font-light leading-relaxed text-base md:text-lg">
            Nascida do profundo respeito pelas tradições vinícolas seculares de
            Alijó, a nossa propriedade alia a rusticidade da pedra de xisto e
            granito ao conforto de uma arquitetura contemporânea de exceção.
            Cada recanto foi pensado para proporcionar uma comunhão perfeita
            entre o hóspede, o rio Douro e a serenidade da serra.
          </p>
        </section>
